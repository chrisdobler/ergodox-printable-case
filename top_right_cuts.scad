...
{
	translate([5,0,0])
		xFemaleCut() drawObject();

//    translate([5,0,0])
	//	yFemaleCut() drawObject();
}

module cutInFour()
{
	translate([5,-5,0])
		xMaleCut() yMaleCut() drawObject();

	translate([-5,-5,0])
		xMaleCut() yFemaleCut() drawObject();

	translate([5,5,0])
		xFemaleCut() yMaleCut() drawObject();

	translate([-5,5,0])
		xFemaleCut() yFemaleCut() drawObject();
}
